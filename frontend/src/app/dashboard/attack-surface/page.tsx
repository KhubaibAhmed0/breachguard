...
export default function AttackSurfacePage() {
  ...
  const getSeverityBadge = (severity: string) => {
    switch (severity?.toLowerCase()) {
      ...
      case 'low':
        return (
          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-semibold uppercase tracking-wider font-roboto bg-blue-500/10 text-blue-300 border border-blue-500/30 shadow-[0_0_10px_rgba(59,130,246,0.14)]">
            LOW
          </span>
        );
      case 'clean':
      case 'secure':
        return (
          <span className="inline-flex items-center px-2.5 py-0.5 rounded-full text-[11px] font-medium uppercase tracking-wider font-roboto bg-emerald-500/10 text-emerald-300 border border-emerald-500/30 shadow-[0_0_10px_rgba(16,185,129,0.14)]">
            SECURE
          </span>
        );
      default:
