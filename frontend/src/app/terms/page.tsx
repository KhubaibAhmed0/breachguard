  ...
  return (
    <div className="min-h-screen bg-[#09090b] text-text-secondary flex flex-col selection:bg-border-strong selection:text-text-primary">
      ...
      <main className="max-w-4xl mx-auto px-4 sm:px-6 py-10 flex-1 space-y-8 text-xs sm:text-sm leading-relaxed text-text-secondary">
        ...
        <div className="p-4 rounded-lg bg-bg-surface border border-border-default text-text-secondary space-y-1.5">
        ...
        <section className="space-y-3">
          ...
          <div className="p-4 rounded-lg bg-bg-surface border border-border-default space-y-2 text-xs">
            <div className="font-semibold text-text-secondary">Customer Authorization Guarantee:</div>
        ...
        <section className="space-y-3">
          ...
          <ul className="list-disc pl-5 space-y-1.5 text-text-muted">
            <li><strong className="text-text-secondary">7-Day Free Trial:</strong> All newly registered organizations receive full access to Business-tier monitoring for seven calendar days without requiring credit card pre-authorization.</li>
            <li><strong className="text-text-secondary">Subscription Fees:</strong> Paid subscriptions are billed in advance on a recurring monthly or annual basis via Stripe. All payments are processed in US Dollars (USD).</li>
            <li><strong className="text-text-secondary">Cancellation:</strong> You may cancel your subscription at any time via the billing portal. Access continues through the conclusion of the active prepaid billing cycle.</li>
          </ul>
        </section>
      ...
      <footer className="border-t border-border-default bg-bg-base py-8 px-4 text-center text-xs text-text-faint">
        &copy; {new Date().getFullYear()} BreachGuard Intelligence. All rights reserved. &bull; <Link href="/privacy" className="hover:text-text-secondary underline underline-offset-4">Privacy Policy</Link>
      </footer>
